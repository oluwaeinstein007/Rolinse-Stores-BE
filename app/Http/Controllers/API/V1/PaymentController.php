...
class PaymentController extends Controller
{
        ...
        try {
            $response = $client->post("{$this->paystackPaymentUrl}/transaction/initialize", [
                ...
                'json' => [
                    ...
                    'callback_url' => env('Frontend_Callback') . '/payment/success?transaction_ref=' . uniqid('psk_'),
                ],
            ]);
        ...
        try {
            $response = $client->post("{$this->flutterwavePaymentUrl}/payments", [
                ...
                'json' => [
                    ...
                    'redirect_url' => env('Frontend_Callback') . '/payment/success?transaction_ref=' . $generatedTxRef,
                    'customer' => [
                        'email' => $request->email,
    ...
    public function initiatePaypalPayment(Request $request)
    {
        ...
        try {
            ...
            $transaction = Transaction::create([
                // reference is automatically generated by Transaction model.
                'amount' => $request->amount,
            ...
            $approveUrl = collect($orderData['links'])->firstWhere('rel', 'approve')['href'] ?? null;
